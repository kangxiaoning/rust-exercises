...
impl Chain {
    ...
    pub fn generate_new_block(&mut self) -> bool {
        ...
        block.tranactions.push(reward_trans);
        block.tranactions.append(&mut self.curr_trans);
        block.count = block.tranactions.len() as u32;
        block.header.merkle = Chain::get_merkle(block.tranactions.clone());
